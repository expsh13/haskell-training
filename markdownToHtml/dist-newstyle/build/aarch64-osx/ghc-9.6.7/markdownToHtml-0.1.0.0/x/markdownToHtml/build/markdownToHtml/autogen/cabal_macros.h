...
/* package markdownToHtml-0.1.0.0 */
#ifndef VERSION_markdownToHtml
#define VERSION_markdownToHtml "0.1.0.0"
#endif /* VERSION_markdownToHtml */
#ifndef MIN_VERSION_markdownToHtml
#define MIN_VERSION_markdownToHtml(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_markdownToHtml */
...
#define CURRENT_COMPONENT_ID "markdownToHtml-0.1.0.0-inplace-markdownToHtml"
